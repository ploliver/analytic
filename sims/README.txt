here are the instructions to redo these simulations

# add analytic to PYTHONPATH, depends on your OS so I'll write my command
...
python example_envs_highz.py
python example_envs_no_adiabatic.py
python3.11 example-spectra-plots.py
python example-spectra-vary-plots.py
